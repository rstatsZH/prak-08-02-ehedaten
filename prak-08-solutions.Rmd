...
In diesem Praktikum arbeitet ihr zum ersten Mal als ein Team an einem gemeinsamen Repo. Ihr seht dies bereits an dem Namen für das Praktikum, welcher nun `prak08-team0X` ist und nicht mehr der euer individueller Benutzername. 
...
- Führt den Befehl Git Befehl "pull" aus
...
**Achtung: Nur Person 1 erledigt die Aufgaben. Person 2 unterstützt verbal, aber schreibt selbst nicht in der R Markdown Datei**
